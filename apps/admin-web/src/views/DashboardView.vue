...
<template>
  ...
  <div v-loading="loading" class="dashboard">
    ...
    <section class="section-heading"><div><span class="eyebrow">READ MODEL</span><h2>系统状态</h2></div><el-tag type="success">只读模式</el-tag></section>
    <div class="status-table"><div><span>API 命名空间</span><code>/api/admin/v1</code><el-tag type="success">在线</el-tag></div><div><span>数据权限</span><span>按项目与 Scope 隔离</span><el-tag>已启用</el-tag></div><div><span>写入操作</span><span>导入、发布、重试、回放</span><el-tag type="info">P1 开放</el-tag></div></div>
  </div>
</template>
