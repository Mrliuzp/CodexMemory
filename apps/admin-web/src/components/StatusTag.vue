...
<template><el-tag class="status-tag" :class="`status-tag--${meta.status}`" :type="meta.type" :size="size" effect="light"><span class="status-tag__dot" />{{ label || meta.label }}</el-tag></template>
