...
<template>
  ...
  <el-container v-else class="shell">
    ...
    <el-container>
      <el-header class="topbar"><div><span class="eyebrow">ADMIN / OBSERVE</span><h1>{{ title }}</h1></div><div class="user-menu"><el-icon><UserFilled /></el-icon><span>{{ displayName }}</span><el-button text @click="logout"><el-icon><SwitchButton /></el-icon>退出登录</el-button></div></el-header>
